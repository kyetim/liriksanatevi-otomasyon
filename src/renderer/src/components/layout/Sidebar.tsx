...
const ROLE_LABELS: Record<string, string> = {
  admin: 'Yönetici', secretary: 'Sekreter', teacher: 'Öğretmen', accountant: 'Muhasebeci'
}
...
const navItems = [
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7h7v7H3zM3 17h7v4H3zM14 3h7v5h-7zM14 11h7v10h-7z" />
      </svg>
    )
  },
  {
...
export default function Sidebar(): JSX.Element {
  ...
  return (
    <aside className="w-60 bg-primary flex flex-col h-full flex-shrink-0">
      {/* Logo */}
      <div className="px-6 py-5 border-b border-primary-600">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-bold text-sm leading-tight">Lirik Sanat Evi</p>
            <p className="text-primary-300 text-xs">Otomasyon Sistemi</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 py-3 border-t border-primary-600">
        {user && (
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '8px 8px 10px' }}>
            ...
            <button
              onClick={logout}
              title="Çıkış Yap"
              style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.35)', padding: '4px', borderRadius: '6px', flexShrink: 0 }}
        ...
        <p className="text-primary-400 text-xs text-center" style={{ marginTop: user ? '0' : undefined }}>v1.0.0</p>
      </div>
    </aside>
  )
}
